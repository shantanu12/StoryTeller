 ...
 */
public class AntDoveFrame1Fragment extends Fragment {
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_ant_dove_frame1, container, false);
        ImageView antImage = (ImageView) v.findViewById(R.id.frame1_imageView);
