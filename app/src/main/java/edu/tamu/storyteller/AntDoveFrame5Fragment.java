 ...
 */
public class AntDoveFrame5Fragment extends Fragment {
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_ant_dove_frame5, container, false);
        ImageView antImage = (ImageView) v.findViewById(R.id.frame5_imageView);
